 ...
 *  for the Lucene termvector.  There are three main data structures:
...
public class TermVector {
  ...
  public int getStemIdx(String stem) {
	  if (str2Index.containsKey(stem))
		  return this.str2Index.get(stem);
	  return -1;
  }
